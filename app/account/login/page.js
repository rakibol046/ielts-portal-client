const Login = () => {
  return (
    <div className="p-2 lg:px-28 lg:py-8 lg:my-20">
      <h2 className="text-2xl font-bold text-center mb-4">Loge in here</h2>
      <div className="bg-white p-8 lg:w-[600px] m-auto ">
        <div className="">
